...
void keyPressed() {
  ...
  if (key=='q') {//if 'q' is pressed then print debg info to the console
    System.out.println(players[currentPlayer].x+" "+players[currentPlayer].y+" "+players[currentPlayer].z);
  }
